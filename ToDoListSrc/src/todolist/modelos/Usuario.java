...
public class Usuario {
    ...
    /**
     * @param tareas: lista de tareas a agregar a las tareas del usuario, una o
     * mas tareas
     *
     * Tarea tarea = new Tarea("nueva tarea"); Tarea tarea2 = new Tarea("nueva
     * tarea 2"); Tarea tarea3 = new Tarea("nueva tarea 3");
     *
     ...
     */
    public void completarTarea(String descripcion,Date fechaFinalizacion) throws Exception {
